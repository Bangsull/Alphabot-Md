...
⚠️ Segala kebijakan dan ketentuan Fikabot di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*) 

Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan Fikabot
😖🙏
`
}
exports.welcome = () =>{
...
exports.leave = () =>{
	return`Selamat tinggal tenang dialam sana >.<
Goodbye`
}
exports.source = () =>{
return`*------「 SOURCE CODE 」 ------*
...
Recode : https://github.com/GaaraDel/Fikabot-Md
`
}
